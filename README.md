...
Work primarily on their assigned module.
Create and modify their own code.
Commit their work regularly.
Push changes to their assigned branch.
Create Pull Requests when their module is ready.
Review or test other members' work when required.
🛠️ Technologies Used
